...
import { ArrowDown, ArrowUp, Loader2, LogOut, Pencil, Plus, Trash2 } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      <header className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
        <h1 className="text-lg font-bold text-black uppercase tracking-wide">Actualités — Administration</h1>
        <button
          type="button"
